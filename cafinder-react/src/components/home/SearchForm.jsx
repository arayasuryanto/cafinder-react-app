...
const SearchForm = () => {
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    // In a real app, we would navigate to the catalog page with these search parameters
    navigate(`/catalog?location=${location}&activity=${activity}&date=${date}`);
  };
    ...
    <div className="container">
      <div className="search-form">
        <div className="search-tabs">
          ...
          <div 
            className={`search-tab ${activeTab === 'activity' ? 'active' : ''}`}
          ...
          <div 
            className={`search-tab ${activeTab === 'dates' ? 'active' : ''}`}
          ...
          <div 
            className={`search-tab ${activeTab === 'guest' ? 'active' : ''}`}
