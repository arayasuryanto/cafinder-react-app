document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize Mapbox
    mapboxgl.accessToken = 'pk.eyJ1IjoiY2FmaW5kZXIiLCJhIjoiY2tuMXRlZ2hlMDFyNzJ1cGdlbm1kY3RiYyJ9.ZUnbX0Da-UU_yB-wkb25Hg';
    ...
    map.on('load', function() {
        ...
        cafes.forEach(cafe => {
            ...
            el.style.backgroundImage = `url('https://cdn.mapmarker.io/api/v1/pin?size=30&background=%23F05438&color=%23FFFFFF&voffset=0&hoffset=0&icon=fa-coffee')`;
    ...
    function updateSavedCafesUI() {
        ...
        // Update count
        document.querySelector('.saved-cafes-count').textContent = savedCafesIds.length;
