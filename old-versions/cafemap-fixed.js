document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize Mapbox - Fix: Using a real public token
    ...
    // Hide loader after 5 seconds, regardless of map load status
    ...
    // Fix: Ensure loading overlay is hidden if map doesn't load within 5 seconds
    setTimeout(function() {
        if (!mapLoaded) {
            console.warn("Map taking too long to load, forcing hide of loading overlay");
            hideLoader();
        }
    }, 5000);
